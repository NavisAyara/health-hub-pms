...
export default function HealthcareWorker() {
  ...
  const handleSearch = async (e) => {
    ...
    const errorMessages = {
      patient_not_found_in_registry:
        "We couldn't find a patient with that National ID in the registry.",
      no_valid_consent_found:
        "No active consent record was found for this patient at your facility.",
      consent_not_active:
        "The patient's consent for this facility is currently inactive or has expired.",
    ...
    try {
      const res = await api(
        `/api/consents/check?national_id=${encodeURIComponent(nationalId)}`,
      );
      ...
      if (data.success && data.data) {
        ...
        throw new Error(
          "Could not retrieve patient data. Please verify the ID and try again.",
        );
      }
    } catch (err) {
      console.error(err);
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-slate-500">
          Search for patients by National ID to view their records.
        </p>
      </div>
          ...
          <div className="p-6 grid gap-6 md:grid-cols-2">
                ...
                <dd className="font-medium text-slate-900">
                  ...
                  patientData.address !== null ? (
                    <div className="flex flex-col">
                      <span>
                        {patientData.address.county},{" "}
                        {patientData.address.sub_county}
                      </span>
                ...
                <dd className="font-medium text-slate-900">
                  ...
                  patientData.emergency_contact !== null ? (
                    <div className="flex flex-col">
                      ...
                      <a
                        href={`tel:${patientData.emergency_contact.phone}`}
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-100 text-sm text-slate-600">
                ...
                <p className="italic">
                  Access to medical records granted. <br /> Use specific modules
                  to view details.
                </p>
              </div>

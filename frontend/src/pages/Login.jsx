    ...
    <div className="flex items-center justify-center min-h-[70vh] bg-gray-50/50">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <a href="/forgot-password" className="text-sm font-medium text-yellow-700 hover:text-yellow-800 hover:underline">
            Forgot password?
          </a>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-slate-500">
            ...
            <a href="/signup" className="font-medium text-yellow-700 hover:text-yellow-800 hover:underline">
              Sign up for free
            </a>
          </p>
        </div>

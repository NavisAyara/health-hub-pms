        ...
        <div className="space-y-3">
          {consents.map((consent) => (
            <div
              ...
              className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
            >
              {/* Left Side: Info */}
                ...
                <div className="flex flex-wrap gap-2 text-sm text-gray-600 ml-6">
                  <span
                    className={`px-2 py-0.5 rounded-md text-xs font-semibold uppercase tracking-wide
                                        ${
                                          consent.consent_type === "view"
                                            ? "bg-blue-100 text-blue-700"
                                            : consent.consent_type === "edit"
                  ...
                  <span className="flex items-center gap-1 text-gray-500 text-xs px-2 py-0.5 rounded bg-gray-50 border border-gray-100">
                    <Clock size={12} />
              ...
              <div className="flex flex-col items-end gap-2 min-w-25">
                <span
                  className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-full capitalize
                                    ${
